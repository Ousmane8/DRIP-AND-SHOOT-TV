...
$(document).ready(function () {
    ...
    function videoSlidesHeight() {
        ...
        $(
            ...
            ".series-videos-carousel .slick-prev, .series-videos-carousel .slick-next"

        ).css("height", videoSliderImgHeight);
    ...
    episodeBtn(
        ...
        $(".episode-wrapper .episode-desc"),

        $(".episode-wrapper .episode-info-btn")

    );

    episodeBtn(

        $(".lb-episode-info .episode-desc"),

        $(".lb-episode-info .episode-info-btn")
            ...
            if ($(this).data("category") === "all-videos") {
                ...
                $(".single-video-wrapper")
                    ...
                    .done(function () {
                        ...
                        $('.single-video-wrapper[data-category*="' + categoryClass + '"]')
    ...
    sliderVideoList.on("afterChange", function (e, slick, currentSlide) {
        ...
        if (currentSlideNumber + visibleVideoSlidesDesktop > visibleSlides) {
            ...
            $(".series-videos-carousel .slick-arrow.slick-next")
        ...
        if (currentSlideNumber == 1) {
            ...
            $(".series-videos-carousel .slick-arrow.slick-prev")
    ...
    $(".single-video-wrapper").on("click", function () {
        ...
        $(".episode-wrapper .episode-item").html(
        ...
        $(".episode-wrapper .episode-item iframe")[0].src +=
        ...
        $("html, body").animate(
            ...
            { scrollTop: $(".episode-wrapper").offset().top },
